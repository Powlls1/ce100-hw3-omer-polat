...
*****************************/
    ...
    public class Class1
    {
        ...
        * 
        * @brief Returns length of LCS for X[0..m-1], Y[0..n-1]
        * 
        * @param [in] fiR [\b String]  function index of  in the serie
        * 
        * @param [in] fiS [\b String] function index of  in the serie
        * 
        * @param [in] a [\b int] function index of  in the serie
        * 
        * @param [in] e [\b int] function index of  in the serie
        * 
        * @retval [\b string[]] return Longest Common Subsequence as a string.
        **/
        ...
        * 
        * @param [in] p [\b int[]]  function index of  in the serie
        * 
        * @param [in] i [\b int] function index of  in the serie
        * 
        * @param [in] j [\b int] function index of  in the serie
        * 
